...
//#endif
		...
		#region --------- Companions, SLine ---------
			...
			UInt128 SLine2 = CL2.SLine0.DifSet(Exclude_cells);
						...
						UInt128 SLine0R = CL0.CrossLine .DifSet(SExo.EscapeCells | SLine0);
						UInt128 SLine1R = CL1.CrossLine .DifSet(SExo.EscapeCells | SLine1);
						UInt128 SLine2R = CL2.CrossLine .DifSet(SExo.EscapeCells | SLine2);
						if(debugPrint){
							G6_SF.__MatrixPrint( Flag:BaseTagObj, SLine0R, SLine1R, SLine2R, "SLine0R SLine1R SLine2R" );
							G6_SF.__MatrixPrint( Flag:BaseTagObj, SLine0, SLine0R, "SLine0 SLine0R" );
							G6_SF.__MatrixPrint( Flag:BaseTagObj, SLine1, SLine1R, "SLine1 SLine1R" );
							G6_SF.__MatrixPrint( Flag:BaseTagObj, SLine2, SLine2R, "SLine2 SLine2R" );
							G6_SF.__MatrixPrint( Flag:BaseTagObj, SLine0|SLine1|SLine2, SLine0R|SLine1R|SLine2R, "SLine0|SLine1|SLine2 SLine0R|SLine1R|SLine2R" );
						}
		#endregion ------------------------------------
		...
		#region --------- Mirror ---------
			...
			//UInt128 MirrorE   = HC81[(dir,rcTag1).DRCHf()] | HC81[(dir,rcTag2).DRCHf()];	
			//UInt128 Mirror1F = Mirror1Fa.DifSet( MirrorE );	//If Target, exclude its own concatenation
			//UInt128 Mirror2F = Mirror2Fa.DifSet( MirrorE );
						if(debugPrint){
