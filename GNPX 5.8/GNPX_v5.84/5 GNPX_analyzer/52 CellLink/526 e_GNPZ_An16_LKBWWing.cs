...
namespace GNPX_space{
    public partial class NXGCellLinkGen: AnalyzerBaseV2{
        ...
        // https://gidoo-code.github.io/Sudoku_Solver_Generator_v5/page43.html
        ...
        public bool  Wwing( ){ 
            ...
            while(cmb.Successor(skip:nxt)){
                ...
                if( ConnectedCells81[P.rc].IsHit(Q.rc) ) continue;
                ...
                foreach( var LK in CeLKMan.IEGetCellInHouse(typB:1) ){      //1:StrongLink(Link has a direction. The opposite link is different.)
                    ...
                    if( !ConnectedCells81[P.rc].IsHit(LK.rc1) )  continue;  //LK.rc1 is in the connected area of ​​P.rc?
                    if( !ConnectedCells81[Q.rc].IsHit(LK.rc2) )  continue;  //LK.rc2 is in the connected area of Q.rc?
                    int no2B = P.FreeB.BitReset(LK.no);                     //another digit
                    
                    string msg2="";
                    UInt128 ELM = ConnectedCells81[P.rc] & ConnectedCells81[Q.rc];//ELM:Common part of the influence area of ​​cell P and cell Q
                    foreach( var E in ELM.IEGet_UCell_noB(pBOARD,no2B) ){         //Cell/digit in ELM can be eliminated
