...
namespace GNPX_space{
    public partial class NXGCellLinkGen: AnalyzerBaseV2{
        ...
        // https://gidoo-code.github.io/Sudoku_Solver_Generator_v5/page42.html
        ...
        public bool XYwing( ){
            ...
            foreach( var UCeStart in BVCellLst ){                               //Choose one BV_Cell(=>PS)
                ...
                while(cmb.Successor(skip:nxt)){                                 //Combine two WeakLinks from BVLKLst
                    ...
                    UInt128 Q81 = ConnectedCells81[LKA.rc2]&ConnectedCells81[LKB.rc2];
                    if( Q81.BitCount()<=0 ) continue;                                //two W_links have cells connected indirectly
                    ...
                    string msg2="";
                    foreach( var A in Q81.IEGet_UCell_noB(pBOARD,noB) ){
                        if( A==UCeStart || A==UCeA2 || A==UCeB2 ) continue;
                        A.CancelB=noB; XYwing=true;                             //cell(A)/digit(no) can be eliminated
