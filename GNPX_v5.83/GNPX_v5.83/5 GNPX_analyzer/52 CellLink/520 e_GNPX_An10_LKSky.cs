...
namespace GNPX_space{
    public partial class NXGCellLinkGen: AnalyzerBaseV2{
        ...
        // https://gidoo-code.github.io/Sudoku_Solver_Generator_v5/page40.html
        ...
        public bool Skyscraper(){
            ...
            for(int no=0; no<9; no++){              
                ...
                while(prm.Successor(nxtX)){                
                    ...
                    if( (UCLa.B81 | UCLb.B81).BitCount() != 4 )  continue;     //All cells are different?

                    UInt128 ConA1 = ConnectedCells81[UCLa.rc1];        //ConA1:cell group related to cell rc1
                    UInt128 ConA2 = ConnectedCells81[UCLa.rc2];        //ConA2:cell group related to cell rc2
                    ...
                    UInt128 ELM = ConA2 & ConnectedCells81[UCLb.rc2];
                    UInt128 ELM2X = ConA1 | ConnectedCells81[UCLb.rc1];

                    ELM = ELM.DifSet( (ConA1 | ConnectedCells81[UCLb.rc1]) );       //ELM:eliminatable cells

                    bool SSfound = false;
                    int noB = (1<<no); 
                    foreach(UCell P in ELM.IEGet_UCell_noB(pBOARD,noB)){ P.CancelB=P.FreeB&noB; SSfound=true; }
                ...
                #region Result
                    ...
                    if( SolInfoB ){
                        ...
                        msg += "\r  eliminated ";
                        foreach(UCell P in ELM.IEGet_UCell_noB(pBOARD,noB)){ msg2 += " "+P.rc.ToRCString(); }
