...
namespace GIDOO_space{
   // public delegate void GIDOOEventHandler( object sender, GIDOOEventArgs args );
    ...
    public partial class NumericUpDownPlus: UserControl{
        public event   GIDOOEventHandler ValueChanged; 
		private bool EventStop=false;
		private string txtMemo;

        public static readonly DependencyProperty ValueProperty    = DependencyProperty.Register(     "Value", typeof(int), typeof(NumericUpDownPlus), new PropertyMetadata(1));
        public static readonly DependencyProperty MinValueProperty = DependencyProperty.Register(  "MinValue", typeof(int), typeof(NumericUpDownPlus), new PropertyMetadata(1));
        public static readonly DependencyProperty MaxValueProperty = DependencyProperty.Register(  "MaxValue", typeof(int), typeof(NumericUpDownPlus), new PropertyMetadata(20));
        public static readonly DependencyProperty IncrementProperty= DependencyProperty.Register( "Increment", typeof(int), typeof(NumericUpDownPlus), new PropertyMetadata(1));
		...
		private void UpButtonP_Click(object sender, RoutedEventArgs e) => Value = MaxValue;// {
     //       Value = MaxValue;
     //   }

		private void DownButtonP_Click(object sender, RoutedEventArgs e) => Value = MinValue;//  {
     //       Value = MinValue;
	 //}
	}
